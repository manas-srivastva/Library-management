...
export default function LoginPage() {
  ...
  const onSubmit = (_data: FormValues) => {
    // NOTE: No backend auth here. This is a UI-only demo that routes to the dashboard.
    toast.success('Welcome back to LibraAI');
        ...
        <div className="glass rounded-2xl p-7 shadow-pop gradient-border">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
            ...
            <label className="flex items-center gap-2 text-sm text-fg-muted">
              <input type="checkbox" className="h-4 w-4 rounded border-border bg-bg-elevated accent-brand-500" />
